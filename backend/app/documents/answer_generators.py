...
class DeterministicAnswerGenerator:
    """
    Development answer generator that builds an answer directly
    from retrieved document chunks.

    This keeps RAG testing deterministic and avoids requiring an
    external LLM during unit and integration tests.
    """
